"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[8305],{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+date@5.50.0/node_modules/@wordpress/date/build-module/index.mjs
var date_build_module = __webpack_require__("../../node_modules/.pnpm/@wordpress+date@5.50.0/node_modules/@wordpress/date/build-module/index.mjs");
...
var deprecated_build_module = __webpack_require__("../../node_modules/.pnpm/@wordpress+deprecated@4.50.0/node_modules/@wordpress/deprecated/build-module/index.mjs");
...
;// ../../node_modules/.pnpm/@ariakit+components@0.1.5/node_modules/@ariakit/components/dist/radio/radio-store.js
...
function createRadioStore(props = {}) {
	...
	const radio = (0,store_dist/* createStore */.y$)({
		...composite.getState(),
		value: (0,utils_dist/* defaultValue */.Jh)(props.value, syncState?.value, props.defaultValue, null)
...
;// ../../node_modules/.pnpm/@ariakit+react-components@0_c942b97430df21eb1cbe19f44c2806d9/node_modules/@ariakit/react-components/dist/radio/radio-store.js
"use client";
...
function useRadioStoreProps(store, update, props) {
	...
	(0,dist/* useStoreProps */.Tz)(store, props, "value", "setValue");
	return store;
}
/**
...
function useRadioStore(props = {}) {
	props = (0,composite_store/* useCompositeStoreOptions */.YC)(props);
	const [store, update] = (0,dist/* useStore */.Pj)(createRadioStore, props);
...
;// ../../node_modules/.pnpm/@ariakit+react-components@0_c942b97430df21eb1cbe19f44c2806d9/node_modules/@ariakit/react-components/dist/radio/radio-context.js
"use client";


//#region src/radio/radio-context.tsx
const ctx = (0,react_utils_dist/* createStoreContext */.B0)([composite_context/* CompositeContextProvider */.ws], [composite_context/* CompositeScopedContextProvider */.aN]);
/**
...
;// ../../node_modules/.pnpm/@ariakit+react-components@0_c942b97430df21eb1cbe19f44c2806d9/node_modules/@ariakit/react-components/dist/radio/radio-group.js
"use client";
...
* ```
*/
const useRadioGroup = (0,react_utils_dist/* createHook */.ab)(function useRadioGroup({ store, ...props }) {
	const context = useRadioProviderContext();
	store = store || context;
	(0,utils_dist/* invariant */.V1)(store,  false && 0);
	props = (0,react_utils_dist/* useWrapElement */.w7)(props, (element) => /* @__PURE__ */ (0,jsx_runtime.jsx)(RadioScopedContextProvider, {
		value: store,
		children: element
	}), [store]);
	const onBlurCaptureProp = props.onBlurCapture;
	const onBlurCapture = (0,react_utils_dist/* useEvent */._q)((event) => {
...
* ```
*/
const RadioGroup = (0,react_utils_dist/* forwardRef */.Rf)(function RadioGroup(props) {
	return (0,react_utils_dist/* createElement */.n)(TagName, useRadioGroup(props));
});
//#endregion
...
function UnforwardedToggleGroupControlAsRadioGroup({
  ...
  const selectedValue = dist/* useStoreState */.O$(radio, "value");
...
;// ../../node_modules/.pnpm/@ariakit+react-components@0_c942b97430df21eb1cbe19f44c2806d9/node_modules/@ariakit/react-components/dist/radio/radio.js
"use client";
...
* ```
*/
const useRadio = (0,react_utils_dist/* createHook */.ab)(function useRadio({ store, name: nameProp, value, checked, ...props }) {
	const context = useRadioContext();
	store = store || context;
	const id = (0,react_utils_dist/* useId */.Bi)(props.id);
	const ref = (0,react.useRef)(null);
	const isChecked = (0,dist/* useStoreState */.O$)(store, (state) => checked ?? getIsChecked(value, state?.value));
	const storeId = (0,dist/* useStoreState */.O$)(store, "id");
	...
	const nativeRadio = isNativeRadio((0,react_utils_dist/* useTagName */.vO)(ref, radio_TagName), props.type);
	const disabled = (0,utils_dist/* disabledFromProps */.$f)(props);
	const [propertyUpdated, schedulePropertyUpdate] = (0,react_utils_dist/* useForceUpdate */.CH)();
	(0,react.useEffect)(() => {
	...
	const onChange = (0,react_utils_dist/* useEvent */._q)((event) => {
		if (disabled) {
			event.preventDefault();
...
* ```
*/
const Radio = (0,react_utils_dist/* memo */.ph)((0,react_utils_dist/* forwardRef */.Rf)(function Radio(props) {
	return (0,react_utils_dist/* createElement */.n)(radio_TagName, useRadio(props));
}));
//#endregion
...
/***/ "../../node_modules/.pnpm/@wordpress+compose@7.33.1_@types+react@18.3.28_react@18.3.1/node_modules/@wordpress/compose/build-module/hooks/use-debounce/index.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js
var react = __webpack_require__("../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");
;// ../../node_modules/.pnpm/@wordpress+compose@7.33.1_@types+react@18.3.28_react@18.3.1/node_modules/@wordpress/compose/build-module/utils/debounce/index.js
